...
% Set Path
spm_dir     = '.../spm12';
script_dir  = '.../firstlv_spm12';
preproc_dir = '.../Data_CBD_noFM';
results_dir = '.../CBD_Lu';%where????????

% Basic Configure
postfix     = 'zhao';
sess_num    = 2;
sess_name   = 'NB';
sess_list   = 'NB'; % Single Run: 'Run'; Multiple Run: 'Run1'',''Run2'',''Run3'.
task_design = 'taskdesign_Lu.m';

sublist     = fullfile(script_dir,'WM.txt');
contrasts   = fullfile(script_dir,'contrast','BrainDev_WM_Cond6.mat');
